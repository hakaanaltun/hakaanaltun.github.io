...
(function(){
  ...
  function measure(){
    ...
    drift.setLimit(footerHeight+24);
  ...
  function paintBank(){
    ...
    if(ground<0 || ground-footerHeight-24>height) return;
    var tallest=0;
    ...
    ctx.strokeStyle='rgba(145,174,198,.28)';ctx.lineWidth=1;ctx.stroke();
  ...
  function step(now){
    ...
    for(var i=0;i<flakes.length;i++){
      ...
      if(flake.radius>1.4){context.lineWidth=.65;context.strokeStyle='rgba(138,165,188,.26)';context.stroke();}
    }
