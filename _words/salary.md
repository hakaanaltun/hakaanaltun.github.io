...
word: salary
title: "salary"
seo_title: "salary, the salt nobody can show was paid &middot; On Life &amp; Everything"
pos: n.
...
description: "Salary comes from the Latin salarium, formed from sal, salt. The familiar claim that Roman soldiers were paid in salt is in no ancient source."
---
...
instead of coin appears to be a later addition, filled in by dictionary-makers
who wanted the connection to mean something
definite.{% include word-cite.html n="3" %}
